...
var backgroundMusic = new MusicEngine('/background_music.mp3', 20, true);
...
function loadingDone() {
    ...
    $('.iziModal').each(function (el) {
        $(this)
            ...
            .css('font-size', 35 * HSR + 'px');
        $(this)
            .find('.iziModal-header-subtitle')
            .css('font-size', 28 * HSR + 'px');
    });
